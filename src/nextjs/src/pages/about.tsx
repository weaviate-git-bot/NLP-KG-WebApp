...
const About = () => {
  ...
  const faqData = [
      ...
      answer: (
          <div>
            ...
            <ul className="list-disc pl-6">
              ...
              <li><b>Advanced Fiters</b> such as e.g., filtering by survey papers to get a quick overview of a specific
                field of interest.
              </li>
    ...
    },
    {
      ...
      answer: (<p>We use the <i>gpt-4-turbo-preview</i> model from OpenAI for our LLM-based features.</p>),
    },
  ];
